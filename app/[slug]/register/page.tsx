...
function RegisterForm() {
  ...
  const redirect = searchParams.get("redirect") || `/${slug}/patient/dashboard`;
    ...
    <div className="min-h-screen bg-[#F4F4F5] flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-sm">
        <div className="text-center mb-6">
          <Link href={`/${slug}`} className="inline-flex items-center gap-2 mb-4">
        ...
        <div className="bg-white rounded-3xl p-7 shadow-sm">
          ...
          <div className="mt-5 pt-4 border-t border-gray-100 text-center">
            <p className="text-sm text-[#6b7280]">
              Already registered?{" "}
              <Link href={`/${slug}/login?redirect=${redirect}`} className="text-[#14967F] font-semibold hover:underline">
                Sign In
              </Link>
            </p>
          </div>
